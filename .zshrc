...
# WSL Chrome for AWS SSO (opens in Windows Chrome Profile 2)
export BROWSER=~/.local/bin/wsl-chrome-aws
...
alias ll='eza -l --git -h --color=always --icons=always --group-directories-first'
